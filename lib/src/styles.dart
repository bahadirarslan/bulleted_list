...
class TextStyles {
  ...
  static const TextStyle raleway = const TextStyle(fontFamily: Fonts.raleway, fontWeight: FontWeight.w400, height: 1, color: Colors.blueGrey);
  static const TextStyle fraunces = const TextStyle(fontFamily: Fonts.fraunces, fontWeight: FontWeight.w400, height: 1, color: Color(0xFF436E7A)); //FF546E7A
  ...
  static TextStyle get s1 => title1.copyWith(fontWeight: FontWeight.w400, fontSize: FontSizes.s14, height: 1.26);
  static TextStyle get s2 => title1.copyWith(fontWeight: FontWeight.w400, fontSize: FontSizes.s14, height: 1.30);
